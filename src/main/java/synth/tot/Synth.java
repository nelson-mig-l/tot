...
public class Synth extends JPanel { //implements ControlContext {
    ...
    class InstrumentsTable extends JPanel {
        ...
        private String names[] =
            {"Piano", "Chromatic Perc.", "Organ", "Guitar", "Bass", "Strings", "Ensemble", "Brass", "Reed", "Pipe",
    ...
    public static void main(String args[]) {
        final Synth midiSynth = new Synth();
        midiSynth.open();
